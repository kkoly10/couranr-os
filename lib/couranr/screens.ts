...
const SCREENS: CanonicalScreen[] = [
  { id: "PUB-001", name: "Marketing homepage", group: "public", routes: ["/business"], tier: "core", phase: "10", viewport: "responsive", status: "functional_unverified" },
  ...
  { id: "PUB-012", name: "Couranr master homepage", group: "public", routes: ["/"], tier: "core", phase: "10", viewport: "responsive", status: "functional_unverified" },
  { id: "PUB-013", name: "Couranr Same Day", group: "public", routes: ["/sameday"], tier: "core", phase: "10", viewport: "mobile-first", status: "functional_unverified" },
  ...
  { id: "OPS-011", name: "Refund management", group: "operations", routes: ["/operations/refunds"], tier: "core", phase: "6–7", viewport: "desktop-primary", status: "functional_unverified" },
  ...
  { id: "OPS-013", name: "Operations analytics", group: "operations", routes: ["/operations/analytics"], tier: "core", phase: "10", viewport: "desktop-primary", status: "functional_unverified" },
  { id: "OPS-014", name: "Unmet demand analytics", group: "operations", routes: ["/operations/analytics?tab=unmet-demand"], tier: "mvp-complete", phase: "10", viewport: "desktop-primary", status: "functional_unverified" },
  { id: "OPS-015", name: "Operations settings", group: "operations", routes: ["/operations/settings"], tier: "core", phase: "3, 8–9", viewport: "desktop-primary", status: "functional_unverified" },
  { id: "OPS-016", name: "Availability controls", group: "operations", routes: ["/operations/settings?tab=availability"], tier: "core", phase: "3, 7", viewport: "desktop-primary", status: "functional_unverified" },
  ...
  { id: "OPS-020", name: "Activity and audit log", group: "operations", routes: ["/operations/settings?tab=audit"], tier: "core", phase: "2–9", viewport: "desktop-primary", status: "functional_unverified" },
  ...
  { id: "CUS-004", name: "Delivery problem report", group: "customer", routes: ["/help/[token]#delivery-problem"], tier: "core", phase: "7–8", viewport: "mobile-first", status: "functional_verified" },
