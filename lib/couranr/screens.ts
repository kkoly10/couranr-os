...
const SCREENS: CanonicalScreen[] = [
  { id: "PUB-001", name: "Marketing homepage", group: "public", routes: ["/"], tier: "core", phase: "10", viewport: "responsive", status: "functional_verified" },
  ...
  { id: "PUB-004", name: "Delivery estimate and hosted request", group: "public", routes: ["/estimate", "/request/[merchantSlug]"], tier: "core", phase: "5–6", viewport: "mobile-first", status: "placeholder_only" },
  ...
  { id: "MER-001", name: "Merchant dashboard", group: "merchant", routes: ["/business"], tier: "core", phase: "4–10", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-002", name: "Merchant onboarding", group: "merchant", routes: ["/business/onboarding"], tier: "core", phase: "4", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-003", name: "Live activation checklist", group: "merchant", routes: ["/business/onboarding?step=activation"], tier: "core", phase: "4", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-004", name: "Deliveries list", group: "merchant", routes: ["/business/deliveries"], tier: "core", phase: "5–8", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-005", name: "Create delivery with Smart Intake", group: "merchant", routes: ["/business/deliveries/new"], tier: "core", phase: "5", viewport: "desktop-first", status: "partial" },
  { id: "MER-006", name: "Delivery review and quote", group: "merchant", routes: ["/business/deliveries/new?step=review"], tier: "core", phase: "6", viewport: "desktop-first", status: "functional_unverified" },
  { id: "MER-007", name: "Delivery detail", group: "merchant", routes: ["/business/deliveries/[id]"], tier: "core", phase: "5–8", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-008", name: "Customers list", group: "merchant", routes: ["/business/customers"], tier: "core", phase: "4", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-009", name: "Customer detail", group: "merchant", routes: ["/business/customers?customer=[id]"], tier: "core", phase: "4", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-010", name: "Presets list", group: "merchant", routes: ["/business/presets"], tier: "core", phase: "4", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-011", name: "Preset builder", group: "merchant", routes: ["/business/presets?edit=[id]"], tier: "core", phase: "4", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-012", name: "Merchant messages and support", group: "merchant", routes: ["/business/messages"], tier: "core", phase: "8–9", viewport: "desktop-first", status: "partial" },
  { id: "MER-013", name: "Website tools", group: "merchant", routes: ["/business/website-tools"], tier: "core", phase: "10", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-014", name: "Merchant settings", group: "merchant", routes: ["/business/settings"], tier: "core", phase: "4–8", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-015", name: "Team and permissions", group: "merchant", routes: ["/business/settings/team"], tier: "core", phase: "4", viewport: "desktop-first", status: "functional_verified" },
  { id: "MER-016", name: "Billing settings", group: "merchant", routes: ["/business/settings/billing"], tier: "core", phase: "6", viewport: "desktop-first", status: "partial" },
  { id: "DRV-001", name: "Driver dashboard", group: "driver", routes: ["/driver"], tier: "core", phase: "7", viewport: "mobile-primary", status: "functional_verified" },
