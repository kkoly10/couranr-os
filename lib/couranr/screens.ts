...
const SCREENS: CanonicalScreen[] = [
  ...
  { id: "PUB-004", name: "Delivery estimate and hosted request", group: "public", routes: ["/send", "/estimate", "/request/[merchantSlug]"], tier: "core", phase: "5–6", viewport: "mobile-first", status: "placeholder_only" },
  ...
  { id: "PUB-012", name: "Couranr master homepage", group: "public", routes: ["/"], tier: "core", phase: "10", viewport: "responsive", status: "missing" },
  { id: "PUB-013", name: "Couranr Same Day", group: "public", routes: ["/sameday"], tier: "core", phase: "10", viewport: "mobile-first", status: "missing" },
