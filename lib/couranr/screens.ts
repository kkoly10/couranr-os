...
export const CANONICAL_SCREENS: CanonicalScreen[] = [
  { id: "PUB-001", name: "Marketing homepage", group: "public", routes: ["/"], tier: "core", phase: "10", viewport: "responsive", implemented: true },
  ...
  { id: "PUB-007", name: "Delivery Help", group: "public", routes: ["/help/[token]"], tier: "core", phase: "8", viewport: "mobile-first", implemented: true },
  { id: "PUB-008", name: "Pricing page", group: "public", routes: ["/pricing"], tier: "core", phase: "10", viewport: "responsive", implemented: true },
  { id: "PUB-009", name: "Businesses page", group: "public", routes: ["/businesses"], tier: "core", phase: "10", viewport: "responsive", implemented: true },
  { id: "PUB-010", name: "Service areas page", group: "public", routes: ["/service-areas"], tier: "core", phase: "10", viewport: "responsive", implemented: true },
  { id: "PUB-011", name: "How Couranr works", group: "public", routes: ["/how-it-works"], tier: "core", phase: "10", viewport: "responsive", implemented: true },
  ...
  { id: "MER-003", name: "Live activation checklist", group: "merchant", routes: ["/business/onboarding?step=activation"], tier: "core", phase: "4", viewport: "desktop-first", implemented: true },
  ...
  { id: "MER-008", name: "Customers list", group: "merchant", routes: ["/business/customers"], tier: "core", phase: "4", viewport: "desktop-first", implemented: true },
  { id: "MER-009", name: "Customer detail", group: "merchant", routes: ["/business/customers?customer=[id]"], tier: "core", phase: "4", viewport: "desktop-first", implemented: true },
  { id: "MER-010", name: "Presets list", group: "merchant", routes: ["/business/presets"], tier: "core", phase: "4", viewport: "desktop-first", implemented: true },
  { id: "MER-011", name: "Preset builder", group: "merchant", routes: ["/business/presets?edit=[id]"], tier: "core", phase: "4", viewport: "desktop-first", implemented: true },
