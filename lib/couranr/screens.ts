...
export const CANONICAL_SCREENS: CanonicalScreen[] = [
  ...
  { id: "MER-005", name: "Create delivery with Smart Intake", group: "merchant", routes: ["/business/deliveries/new"], tier: "core", phase: "5", viewport: "desktop-first", implemented: false },
  { id: "MER-006", name: "Delivery review and quote", group: "merchant", routes: ["/business/deliveries/new?step=review"], tier: "core", phase: "6", viewport: "desktop-first", implemented: false },
  { id: "MER-007", name: "Delivery detail", group: "merchant", routes: ["/business/deliveries/[id]"], tier: "core", phase: "5–8", viewport: "desktop-first", implemented: false },
  ...
  { id: "OPS-002", name: "Queue and managed dispatch", group: "operations", routes: ["/operations/queue", "/operations/deliveries"], tier: "core", phase: "7", viewport: "desktop-primary", implemented: false },
  ...
  { id: "CUS-005", name: "Revised quote approval", group: "customer", routes: ["/pay/[token]?mode=requote"], tier: "core", phase: "6–7", viewport: "mobile-first", implemented: false },
