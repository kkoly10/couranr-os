...
try {
  ...
  { let ok = false, detail = "";
    try {
      runSql("supabase/rollbacks/20260917180000_couranr_secure_pickup_photo_burden.rollback.sql");
  ...
  { let ok = false, detail = "";
    try {
      runSql("supabase/migrations/20260917180000_couranr_secure_pickup_photo_burden.sql");
