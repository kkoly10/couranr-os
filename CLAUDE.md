...
1. `02_DECISION_REGISTRY.json` **at the repo root** — rank-1 authority for pricing, hours, payer behavior, states, terminology, launch gates. **43 decision records** (96,889 bytes, sha256 `855469d96ee3fdf38419bf775a4f69c900df9cb82ad710c98ab3841af7ba98ee`, re-measured at `5221e3d`; the 92,872/`b4b158a0` fingerprint this line used to carry no longer matches the file); an earlier note here said 40, and before that said the file did not exist at all. Count it, do not quote this number back.
