...
import { arriveAtDropoff, isDriverFailure } from "@/lib/couranr/driver/commands";
...
/**
 * POST — the driver is at the recipient (`in_transit -> at_dropoff`).
 *
 * Arriving is not delivering. This route records presence only; which
