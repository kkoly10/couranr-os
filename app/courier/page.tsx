...
export default function CourierPage() {
   ...
   * (Google Maps will replace this)
   */
  const mockDistanceMiles = 18; // pretend result from maps
          ...
          <div className="card" style={{ maxWidth: 620 }}>
            ...
            {calculated && price !== null && (
              ...
              >
                ...
                <p style={{ marginTop: 8 }}>${price.toFixed(2)}</p>

                <p style={{ color: "var(--muted)", fontSize: 14 }}>
                  Final price confirmed before checkout. Taxes and additional
                  services may apply.
                </p>
