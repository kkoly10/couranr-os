...
const FORWARD = "supabase/migrations/20260917160000_couranr_secure_pickup_photo_burden.sql";
const ROLLBACK =
  "supabase/rollbacks/20260917160000_couranr_secure_pickup_photo_burden.rollback.sql";
