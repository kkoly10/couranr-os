...
const STAGES = [
  ...
  ...[
    ...
    ["test:driver-profile-tips", "approved public driver identity, private delivered-only reviews, company-held tip liability, reversals and rollback refusal"],
