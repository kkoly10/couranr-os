...
what went stale: it counted 39 migrations while 61 were on disk.
...
|---|---|
| `P5-001` | NATURAL-LANGUAGE AI IS NOT PILOT-LIVE: no approved provider is selected or configured. The platform degrades to manual structured intake by design. |
...
| `7df44bc3ebda4fb2f2170762485df5ce998ba281` | 1 work item | P5-001 |
...
| `c90ec4025fad951cc6a26eea208a687cc18c8cef` | 1 work item, 2 screens | P4-002, MER-005, OPS-003 |
