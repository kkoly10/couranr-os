<!-- PRESERVED SNAPSHOT — the record below is unchanged. -->

> **EVIDENCE, not current status.** This is `IMPLEMENTATION_STATUS.md` as it
> stood on 2026-08-06, moved here whole when that file became generated. Nothing
> below was rewritten to look current, and nothing below outranks live authority.
>
> Current state is generated into `docs/couranr-mvp/IMPLEMENTATION_STATUS.md`
> from the two ledgers and a repository scan. The per-row detail — what was
> verified at each SHA, and how — lives in the ledgers themselves, which is
> where it was always authoritative; this document restated it.
