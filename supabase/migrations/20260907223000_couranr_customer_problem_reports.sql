...
begin
  ...
  if p_object_path is null
     or left(p_object_path,length(v_prefix))<>v_prefix
     or p_object_path !~ '^customer-problem/v1/[0-9a-f-]{36}/[0-9a-f-]{36}/[0-9a-f-]{36}/[0-9a-f]{32}\.(jpg|png|webp|heic)
  p_evidence_id uuid,
  p_actual_path text,
...
commit;
 then
  ...
  -- with the immutable expected envelope. We rotate to a fresh opaque object
