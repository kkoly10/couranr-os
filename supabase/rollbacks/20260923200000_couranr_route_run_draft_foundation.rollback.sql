...
drop table public.couranr_route_run_events restrict;
drop table public.couranr_route_run_stops restrict;
drop table public.couranr_route_run_versions restrict;
drop table public.couranr_route_runs restrict;
commit;
