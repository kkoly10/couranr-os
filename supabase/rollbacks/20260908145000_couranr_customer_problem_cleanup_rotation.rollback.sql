...
-- Restore the pre-correction prepare function. No customer report/evidence rows
-- are deleted; this only removes the storage-cleanup marker reset on rotation.
